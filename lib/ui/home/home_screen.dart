                      ...
                      Container(
                          ...
                          child: RowSuper(fill: true, children: [
                            ColumnSuper(alignment: Alignment.centerLeft, children: [
                              ...
                              Text(
                                currencyFormat.format(double.tryParse("${ref.watch(sharedUtilityProvider).getUser()?.wallet??"0.0"}")),
                                style: TextStyle(
                                    shadows: const [
                                      Shadow(color: Colors.black, blurRadius: 2.0),
                                      Shadow(color: Colors.black, blurRadius: 2.0)
                      ...
                      Container(
                          ...
                          child: RowSuper(fill: true, children: [
                            ColumnSuper(alignment: Alignment.centerLeft, children: [
                              ...
                              ref.watch(bnplPowerProvider).when(data: (bnplData)=> Text(
                                currencyFormat.format(double.tryParse("${bnplData.bnpl?.effectiveBalance??0.0}")),
                                style: TextStyle(
                                    shadows: const [
                                      Shadow(color: Colors.black, blurRadius: 2.0),
                                      Shadow(color: Colors.black, blurRadius: 2.0)
                                    ...
                                    fontSize: Adaptive.sp(22),
                                    color: Colors.white),
                              ), error: (e,s)=>Container(), loading: ()=>Center(child: CupertinoActivityIndicator(),))
                            ]),
                          ])),
                    ],
                  ),
