                                                                  ...
                                                                  itemBuilder: (context,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Row(
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                                child: Text("${data.data?[schemeIndex].scheme?.schemeName ?? ""}",
                                                                                    textAlign: TextAlign
                                                                                        .center,
                                                                                    style: TextStyle(
                                                                                        fontSize: Adaptive.sp(
                                                                                        ...
                                                                                        fontWeight: FontWeight.w800))),
                                                                            Expanded(
                                                                                child: Text(data.data?[schemeIndex].processingFee ?? "",
                                                                                    textAlign: TextAlign
                                                                                        .center,
                                                                                    style: TextStyle(
                                                                                        fontSize: Adaptive.sp(
                                                                                        ...
                                                                                        fontWeight: FontWeight.w800))),
                                                                            Expanded(
                                                                                child: Text(data.data?[schemeIndex].interestRate ?? "",
                                                                                    textAlign: TextAlign
                                                                                        .center,
                                                                                    style: TextStyle(
                                                                                        fontSize: Adaptive.sp(
                                                                                        ...
                                                                                        fontWeight: FontWeight.w800))),
                                                                            Expanded(
                                                                                child: Text(data.data?[schemeIndex].scheme?.loanPerTotalAmount ?? "",
                                                                                    textAlign: TextAlign
                                                                                        .center,
                                                                                    style: TextStyle(
                                                                                        fontSize: Adaptive.sp(
                                                                                        ...
                                                                                        fontWeight: FontWeight.w800))),
                                                                            Expanded(
                                                                                child: Text("${data.data?[schemeIndex].scheme?.tenor} ${data.data?[schemeIndex].scheme?.tenorType}",
                                                                                    textAlign: TextAlign
                                                                                        .center,
                                                                                    style: TextStyle(
                                                                                        fontSize: Adaptive.sp(
