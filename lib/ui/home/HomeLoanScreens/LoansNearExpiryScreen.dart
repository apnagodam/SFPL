...
class Loansnearexpiryscreen extends ConsumerWidget {
  const Loansnearexpiryscreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Loans Near Expiry(within 30 days)'),
      ),
      body: SafeArea(child: loansNearExpiryWidget(ref, context)),
    );
  }

  loansNearExpiryWidget(WidgetRef ref, BuildContext context) => ListView(
        children: [
          Container(
          ...
          ref.watch(nearExpiryLoansProvider).when(
