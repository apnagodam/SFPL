...
class _PropregistrationState extends ConsumerState<Propregistration> {
                                ...
                                onPressed: () async {
                                  if (ref.watch(activeStepProvider) == 0) {
                                    ...
                                    if (identificationKey.currentState!
                                      ...
                                      //       'Please select PAN card Image');
                                      // }
                                      // if (ref.watch(adharImageProvider) ==
                                      //     null) {
                                      //   errorToast(context,
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    if (formKey.currentState!.validate() &&
                                        personalDetailsKey.currentState!
                                            .validate()) {
                                      if (ref.watch(
                                        ...
                                        ref
                                            .watch(registerUserProvider(
                                                    ...
                                                    bankBranch: ref.watch(sharedUtilityProvider).getMongoDbUser()?.bankBranch ?? branchController.text.toString(),
                                                    bankAccount: accountController.text.toString(),
                                                    ifscCode: ifscController.text.toString(),
                                                    propDocType: ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof != null && ref.watch(propTypeProvider).isEmpty ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof : ref.watch(propTypeProvider),
                                                    ...
                                                    proprietorProof: ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofDoc != null && ref.watch(propDocImageProvider) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofDoc : ref.watch(propDocImageProvider),
  ...
  firmLayout(BuildContext context, WidgetRef ref) => Form(
      ...
      child: ColumnSuper(children: [
        ...
        if (ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofNo ==
            null)
          Column(
            children: [
              ...
              Visibility(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        label:
                            Text("Enter ${ref.watch(propDocProvider)} Number"),
                        enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10)),
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10)),
