...
class _PartnershipregistrationState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      gstController.text =
          ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofNo;

      directorController.text = ref
                                      ...
                                      if (ref.watch(
                                        ...
                                        ref
                                            .watch(registerUserProvider(
                                                    ...
                                                    locationState:
                                                        ref.watch(sharedUtilityProvider).getMongoDbUser()?.state ??
                                                            ref
                                                                ...
                                                                ?.name
                                                                .toString(),
                                                    district: ref.watch(sharedUtilityProvider).getMongoDbUser()?.district ??
                                                        ref
                                                            .watch(
                                                                districtProvider)
                                                            ?.name
                                                    ...
                                                    profileImage: ref.watch(sharedUtilityProvider).getMongoDbUser()?.profileImage != null && ref.watch(moaAoaImageProvider) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.profileImage : ref.watch(moaAoaImageProvider),
                                                    ...
                                                    proprietorProof: ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofDoc != null &&
                                                            ref.watch(
                                                                  propDocImageProvider,
                                                                ) ==
                                                                null
                                                        ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProofDoc
                                                        : ref.watch(propDocImageProvider),
                                                    boardResolution: ref.watch(sharedUtilityProvider).getMongoDbUser()?.partnershipDeepImage != null && ref.watch(boardResolutionImage) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.partnershipDeepImage : ref.watch(boardResolutionImage),
  ...
  addressLayout(BuildContext context, WidgetRef ref) => Form(
        ...
        ref.watch(sharedUtilityProvider).getMongoDbUser()?.district != null &&
            ...
            ? TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please input Valid city';
                  }
                  return null;
                },
                decoration: InputDecoration(
  ...
  firmLayout(BuildContext context, WidgetRef ref) => Form(
      ...
      child: ColumnSuper(children: [
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  label: const Text("Enter Firm Email"),
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  label: const Text("Enter Firm Phone Number"),
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
        ...
        if (ref.watch(propDocProvider).isEmpty)
          SizedBox(
            width: MediaQuery.of(context).size.width,
            child: ElevatedButton(
              onPressed: () {
        ...
        Visibility(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  hintText:
                      "Enter ${ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof.toString() == "1" ? ' GST' : ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof.toString() == "2" ? " License" : "MSME"} Number",
                  label: Text(
                      "Enter${ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof.toString() == "1" ? ' GST' : ref.watch(sharedUtilityProvider).getMongoDbUser()?.propProof.toString() == "2" ? "License" : " MSME"} Number"),
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
                        ...
                        child: Center(
                          child: ref.watch(boardResolutionImage) != null
                              ? Stack(
                                  children: [
                                    Image.file(
                                        ref.watch(boardResolutionImage) ??
                                            File('path')),
                                    Container(
                                      decoration: BoxDecoration(
                                          color: Colors.black.withOpacity(0.6),
