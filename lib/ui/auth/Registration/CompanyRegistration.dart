                                      ...
                                      if (ref.watch(
                                        ...
                                        ref
                                            .watch(registerUserProvider(
                                                    ...
                                                    propDocType: ref.watch(propTypeProvider).toString(),
                                                    ...
                                                    moaAoa: ref.watch(sharedUtilityProvider).getMongoDbUser()?.moaAoaImage != null && ref.watch(moaAoaImageProvider) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.moaAoaImage : ref.watch(moaAoaImageProvider),
                                                    boardResolution: ref.watch(sharedUtilityProvider).getMongoDbUser()?.boardResolutionImage != null && ref.watch(boardResolutionImage) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.boardResolutionImage : ref.watch(boardResolutionImage),
                                                    directorProof: ref.watch(sharedUtilityProvider).getMongoDbUser()?.directorProofImage != null && ref.watch(directorProofImage) == null ? ref.watch(sharedUtilityProvider).getMongoDbUser()?.directorProofImage : ref.watch(directorProofImage),
  ...
  firmLayout(BuildContext context, WidgetRef ref) => Form(
      ...
      child: ColumnSuper(children: [
        ...
        CupertinoButton(
            ...
            onPressed: () {}),
        ref.watch(sharedUtilityProvider).getMongoDbUser()?.moaAoaImage !=
                    null &&
        ...
        CupertinoButton(
            ...
            onPressed: () {}),
        ref.watch(sharedUtilityProvider).getMongoDbUser()?.directorProofImage !=
                    null &&
