...
RepaymentSettlementList repaymentSettlementListFromMap(String str) =>
    RepaymentSettlementList.fromMap(json.decode(str));

String repaymentSettlementListToMap(RepaymentSettlementList data) =>
...
class RepaymentSettlementList {
  ...
  factory RepaymentSettlementList.fromMap(Map<String, dynamic> json) =>
      RepaymentSettlementList(
        status: json["status"],
