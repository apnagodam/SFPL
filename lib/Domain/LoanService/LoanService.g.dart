...
String _$surepassPdcHash() => r'efbc7056d6f09db129006b86fc36e3989b08e9d1';
...
class SurepassPdcFamily extends Family<AsyncValue<Map<String, dynamic>>> {
  ...
  SurepassPdcProvider getProviderOverride(
    ...
    return call(
      ...
      gurantor: provider.gurantor,
      guarantorNumber: provider.guarantorNumber,
...
class SurepassPdcProvider
  ...
  SurepassPdcProvider._internal(
    ...
    required this.gurantor,
    required this.guarantorNumber,
  ...
  final String? gurantor;
  final String? guarantorNumber;
  ...
  bool operator ==(Object other) {
    return other is SurepassPdcProvider &&
        ...
        other.gurantor == gurantor &&
        other.guarantorNumber == guarantorNumber &&
  ...
  int get hashCode {
    ...
    hash = _SystemHash.combine(hash, gurantor.hashCode);
    hash = _SystemHash.combine(hash, guarantorNumber.hashCode);
...
mixin SurepassPdcRef on AutoDisposeFutureProviderRef<Map<String, dynamic>> {
  ...
  /// The parameter `gurantor` of this provider.
  String? get gurantor;

  /// The parameter `guarantorNumber` of this provider.
  String? get guarantorNumber;
...
class _SurepassPdcProviderElement
  ...
  @override
  String? get gurantor => (origin as SurepassPdcProvider).gurantor;
  @override
  String? get guarantorNumber =>
      (origin as SurepassPdcProvider).guarantorNumber;
  @override
